...
<body>
    ...
    <div class="container" id="signIn">
        ...
        <form method="post" action="register.php">
            ...
            <p class="recover">
                <a href="ForgetPassword.php" id="forget-password-btn">forgot password?</a>
            </p>
        ...
        <div class="logo">
            <img src="Google-Logo-PNG-Photo-Image.png" alt="Google logo" width="30" height="30">
            <img src="fb.jpg" alt="fb logo" width="30" height="30">
        </div>
        <div class="links">
